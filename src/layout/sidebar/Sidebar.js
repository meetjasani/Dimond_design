        ...
        <>
            ...
            {togglemenu ?
                <div className="w-20 2xl:w-24  bg-white text-center z-50 fixed mt-16 border h-screen border-gray-200 ">
                    {navigation.map(item => {
                        return (
                            <Link to={item.Linkto} className={location.pathname === item.Linkto ? 'block 2xl:py-4 py-2 bg-yellow-50 border-l-4 border-scogoprimary' : 'block 2xl:py-4 py-2 hover:bg-yellow-50'} >
